...
from tabelog.items import RestaurantItem, ReviewItem, TopRestaurantItem

class RamenSpider(scrapy.Spider):
    name = "top_restaurant_spider"
...
# 'https://tabelog.com/rstLst/sushi/' + str(i) for i in range(1,pagesToCrawl)
    start_urls = [
        'https://tabelog.com/kyoto/rstLst/sushi/?SrtT=rt&Srt=D&sort_mode=1'
    ...
    # price_range = scrapy.Field()
        ...
        nameList = response.xpath('//a[contains(@class, "list-rst__rst-name-target")]/text()').extract()
    ...
    def _translate(self, s):
        ...
        self.logger.info('translating: ' + s)
